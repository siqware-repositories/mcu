...
@section('page-content')
    ...
    <div class="page-header">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Testimonial</span>
                </h4>
            </div>
        </div>
    </div>
    ...
    @endif
        <!-- Basic card -->
            <form class="card" action="{{route('backend.testimonial.store')}}" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Content</label>
                        <textarea class="form-control" name="content" cols="30" rows="10" placeholder="Content here..."></textarea>
                    </div>
                </div>
    ...
    <script>
        $(function () {
            ...
            $('#gallery-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: route('backend.testimonial.list'),
                    method:'post'
                },
                columns: [
