...
@section('page-content')
    ...
    <div class="page-header">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Event</span> - Create
                </h4>
    ...
    <div class="content pt-0">
        <!-- Basic card -->
        <form class="card" action="{{route('backend.event.store')}}" method="post">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>Open</label>
                            <input type="datetime-local" name="open" class="form-control">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
