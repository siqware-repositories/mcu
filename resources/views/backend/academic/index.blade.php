    ...
    <div class="page-header">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Academic</span> - List
                </h4>
    ...
    <div class="content pt-0">
        <div class="card">
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="academic-table">
                    <thead>
                    <tr>
    ...
    <script>
        $(function () {
            ...
            $('#academic-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: route('backend.academic.list'),
                    method: 'post'
                },
                columns: [
