    ...
    <div class="page-header">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Setting</span> - Home</h4>
            ...
            <div class="header-elements d-none text-center text-md-left mb-3 mb-md-0">
                <div class="btn-toolbar justify-content-center">
                    <div class="btn-group mr-2">
                        <a href="{{route('backend.history.index')}}" class="btn btn-info">History</a>
                        <a href="{{route('backend.founder.index')}}" class="btn btn-info">Founder</a>
                        <a href="{{route('backend.rector.index')}}" class="btn btn-info">Rector</a>
                        <a href="{{route('backend.corporation.index')}}" class="btn btn-info">Corporation</a>
                    </div>
                </div>
            </div>
        </div>
