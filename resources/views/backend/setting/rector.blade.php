...
@section('page-content')
    ...
    <div class="page-header">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Setting</span> - Rector
                </h4>
    ...
    <div class="content pt-0">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('backend.rector.update',$rector->id)}}" method="post">
                    @csrf
                    <input type="hidden" name="_method" value="put">
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="name" value="{{$rector->name}}" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Profile</label>
                    ...
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" name="title" value="{{$rector->title}}" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Content</label>
                        <textarea name="content" id="example" cols="30" rows="10">{{$rector->content}}</textarea>
                    </div>
                    <div class="form-group">
